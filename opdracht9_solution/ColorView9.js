function ColorView(col)
{
	...
	this.dom.style.cssText = "text-align: center; line-height: 150px;user-select: none; cursor: pointer; width: 150px; height: 150px; border: 1px solid black; display: inline-block; margin: 5px;"; 
