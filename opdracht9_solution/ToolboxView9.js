...
{
	var context=this;
	this.model=model; // hou een referentie naar het model, om het makkelijk te kunnen displayen (dus alleen om te LEZEN)!

	// let op, dit is een handige notatie, maar werkt niet in IE8 (tweede antwoord), http://stackoverflow.com/questions/1720320/how-to-dynamically-create-css-class-in-javascript-and-apply	
	// je kunt natuurlijk altijd stylesheets in HTML zetten, maar dit houdt wel alles mooi bij elkaar.
	...
	this.handleRadioButtonClick=function (ev)
	{
		...
		{
			// alle andere radio buttons moeten uit.
			// we vertellen de presenter van de wisseling van het model.
			// het model doet een update en roept weer de view aan.
